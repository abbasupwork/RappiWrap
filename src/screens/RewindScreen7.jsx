...
const RewindScreen5 = ({ pageNumber, totalPages, isActive }) => {
  ...
  return (
    <>
      <BaseRewindScreen className="rewind-screen-7">
          ...
          <div className="w-full">
            <div className="flex items-start justify-between pl-6">
              ...
              <img
                ...
                className="h-[250px] animate-fade-in-2"
                src={GirlImage}
                alt=""
              />
            </div>
            <div className="px-6">
              <div
                ...
                className="flex flex-col items-start animate-fade-in-3"
              >
              ...
              <div
                ...
                className="grid grid-cols-2 gap-4 mt-6 animate-fade-in-4"
              >
