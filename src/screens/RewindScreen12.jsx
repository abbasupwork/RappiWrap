        ...
        <div className="overflow-y-auto">
          <div className="pt-5 px-6 w-full h-[256px] bg-gradient-to-br from-[#FF7A4D] via-[#FF2526] to-[#FF4583]">
            ...
            <div
              ...
              className="bg-[url('./assets/images/FOTO.jpg')] bg-center bg-cover bg-no-repeat w-full h-[300px] rounded-[32px] p-5 animate-fade-in-2"
            >
          ...
          <div
            ...
            className="px-6 pt-[130px] animate-fade-in-3"
          >
