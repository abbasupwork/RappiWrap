          ...
          <div className="w-full">
            <div className="bg-gradient-to-br from-[#FF7A4D] via-[#FF2526] to-[#FF4583] w-full px-6 pt-5 pb-10 text-white">
              <img
                ...
                src={moustache}
                alt=""
                className="mb-4 mx-auto animate-fade-in-1"
              />
              <h3
                key={`title-${animationKey}`}
                className="text-[38px] font-bold leading-[33px] mb-2 animate-fade-in-2"
              >
                La Hamburguesería
              </h3>
              <p
                key={`subtitle-${animationKey}`}
                className="text-xl mb-5 animate-fade-in-3"
              >
                fue donde más pediste este año.
              </p>
              <img
                key={`burger-${animationKey}`}
                src={BurgerImage}
                alt=""
                className="mx-auto mb-2 w-[220px] animate-fade-in-4"
              />
              <p
                key={`burger-text-${animationKey}`}
                className="text-xl font-semibold text-center animate-fade-in-5"
              >
            ...
            <div
              ...
              className="relative top-[-30px] mx-6 animate-fade-in-6"
            >
